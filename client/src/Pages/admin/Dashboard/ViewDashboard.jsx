...
const ViewDashboard = () => {
  ...
  return (
    <div className="admin__content">
      ...
      >
        <DashboardCard title="Users" data={users} link="/admin/user" />
        <DashboardCard title="Candidates" data={candidates} link="/admin/candidate" />
        <DashboardCard title="Elections" data={elections} link="/admin/election" />
      </div>
    </div>
  );
};
